...
const MOCK_NOTIFS: Notification[] = [
  {
    ...
    message: "12 orders are awaiting approval",
  ...
  },
  {
    ...
    message: "Campaign #45 delivered to 2,340 subscribers",
  ...
  },
  {
    ...
    message: "priya.sharma@example.com created an account",
  ...
  },
  {
    ...
    message: "Order #MRK-2891 payment could not be processed",
  ...
  },
  {
    ...
    message: '"Professional Resume v2" is now live',
  ...
  },
  {
    ...
    message: '"Design Trends 2025" scheduled for tomorrow 9 AM',
...
export default function NotificationsDrawer({ open, onClose }: Props) {
  ...
  return (
    <Drawer
      ...
      BackdropProps={{
        sx: { backdropFilter: "blur(4px)", background: "rgba(13,27,42,0.5)" },
      }}
    >
          ...
          <AnimatePresence>
            {notifs.length === 0 ? (
              <Box sx={{ py: 8, textAlign: "center" }}>
                <Typography
                  sx={{ color: "text.disabled", fontSize: "0.88rem" }}
                >
                  No notifications
                </Typography>
              </Box>
        ...
        <Box sx={{ p: 2, borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <Button
            ...
            sx={{
              ...
              "&:hover": { borderColor: alpha(GOLD, 0.4), color: GOLD },
            }}
            onClick={() => setNotifs([])}
          >

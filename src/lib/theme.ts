  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        outlined: {
          ...
          color: GOLD,
          "&:hover": { borderColor: GOLD, background: alpha(GOLD, 0.08) },
        },
      },
    },
    MuiTextField: {
    ...
    MuiTableCell: {
      styleOverrides: {
        ...
        body: { borderBottom: `1px solid ${BORDER}`, fontSize: "0.875rem" },
      },
    },
    MuiTableRow: {
      styleOverrides: {
        root: {
          ...
          "&:hover": { background: alpha(GOLD, 0.04) },
        },
      },
    },
    MuiDrawer: {
      styleOverrides: {
        paper: { border: "none", borderRight: `1px solid ${BORDER}` },
      },
    },
    MuiDialog: {
      styleOverrides: {
        paper: { borderRadius: 16, border: `1px solid ${BORDER}` },
      },
    },
    MuiTooltip: {
      styleOverrides: {
    ...
    MuiLinearProgress: {
      styleOverrides: {
        root: { borderRadius: 4, background: alpha(GOLD, 0.1) },
        bar: { background: `linear-gradient(90deg, ${GOLD}, #D4B96A)` },
      },
    },
    MuiTab: {
      styleOverrides: {
    ...
    MuiTabs: {
      styleOverrides: {
        indicator: { background: GOLD, height: 2 },
      },
    },
    MuiIconButton: {
      styleOverrides: {
        root: {
          ...
          "&:hover": { background: alpha(GOLD, 0.1), transform: "scale(1.05)" },
        },
      },
    },
    MuiMenu: {
      styleOverrides: {
        paper: { borderRadius: 12, border: `1px solid ${BORDER}` },
      },
    },
    MuiMenuItem: {
      styleOverrides: {
